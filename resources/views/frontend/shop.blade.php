                ...
                <div class="col-lg-3 col-md-12 col-12">
                    ...
                    <div class="left-shop">
                                        ...
                                        <div class="accordion-body">
                                            <ul>
                                                @foreach ($allCategories as $category)
                                                    <li><a
                                                            href="{{ route('categories.detail', $category->slug) }}">{{ $category->name }}</a>({{ $category->allProducts()->count() }})
                                                    </li>
                                                @endforeach
                        ...
                        <div class="shop-filter">
                            <form id="price-form" action="{{ route('shop.filter') }}" method="POST">
                                @csrf
                    ...
                    <div class="right-shop">
                        ...
                        <div class="right-shop__filter">
                            ...
                            <div class="right-shop__filter--sort-by">
                                <h2>Sắp xếp</h2>
                                <form id="order-form" action="{{ route('shop.filter') }}" method="POST">
                                    @csrf
                            ...
                            <div class="product-list view-wraps list-view" style="display: none">
                                ...
                                @else
                                    <div class="col-12 text-center mt-4">
                                        <h2>Không có sản phẩm thỏa mãn điều kiện của bạn</h2>
                                    </div>
                        @endif
                    </div>
                </div>
